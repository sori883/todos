...
実際のプロダクションアプリケーションに基づく: [Zenith](https://zenith.chat) - AI搭載カスタマーディスカバリープラットフォーム。
...
1. **絵文字禁止** コード、コメント、ドキュメントにおいて
2. **イミュータビリティ** - オブジェクトや配列を変更しない
3. **TDD** - 実装前にテストを書く
4. **80%カバレッジ** 最低要件
5. **多数の小さなファイル** - 200-400行が典型、800行が上限
6. **console.log禁止** プロダクションコードにおいて
